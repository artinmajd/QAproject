...
# Set OpenAI API key
os.environ["OPENAI_API_KEY"] = "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"
...
if selected_option =='QA Pairs':
    ...
    db = FAISS.load_local('faiss_db_covid_abstracts', embeddings, allow_dangerous_deserialization=True)
